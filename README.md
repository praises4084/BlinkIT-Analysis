Architected a $1.20M Retail Performance Dashboard to audit 9K+ inventory items, identifying key revenue drivers across multiple outlet tiers and establishment types.

Designed a dynamic Matrix with Heat Mapping to compare metrics (Total Sales, Avg Rating, Visibility) across Grocery and Supermarket types, optimizing outlet-level performance tracking.
